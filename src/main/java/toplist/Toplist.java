...
public class Toplist {
	...
	public void createToplistXML() {
		...
		toplistFile = new File(System.getProperty("user.home") + System.getProperty("file.separator") + "toplist.xml");
	...
	public void updateToplistXML(int levelId, int time) {
		try {
	         ...
	         //System.out.println(nNode);
	         //Node choosenOne = doc.getElementById(Integer.toString(levelId));
	        // System.out.println(choosenOne);
	         //NodeList nList = choosenOne.getChildNodes();
	        ...
	        /* for (int i = 0; i < nList.getLength(); i++) {
	            ...
	            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
	               Element eElement = (Element) nNode;
	               if("time".equals(eElement.getNodeName())) {
	            	   eElement.setTextContent(Integer.toString(time));
	            	   //getElementsByTagName("time").item(0).setNodeValue(Integer.toString(time));
	            	   //setTextContent(Integer.toString(time));
	            		   //eElement.setTextContent(Integer.toString(time));
	            	   //System.out.println("heere");
	            	   //Node levelNode = eElement.getElementsByTagName("level").item(0);
	            	   //levelNode.setNodeValue(Integer.toString(time));
